...
\lstinputlisting[language=Python,caption = Server initialization, firstline=13, lastline=17]{code/serverPy.py}
...
\lstinputlisting[language=Python,caption = Client initialization, firstline=5, lastline=7]{code/client.py}
