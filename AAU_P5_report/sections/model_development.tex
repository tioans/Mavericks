...
\lstinputlisting[language=Python,caption = BiRNN Layer, flexiblecolumns=true, firstline=694, lastline=702]{code/rnn.py}
...
\lstinputlisting[language=Python,caption = BiRNN Layer, flexiblecolumns=true, firstline=718, lastline=723]{code/rnn.py}
...
\lstinputlisting[language=Python,caption = Third fully connected layer, flexiblecolumns=true, firstline=732, lastline=737]{code/rnn.py}
