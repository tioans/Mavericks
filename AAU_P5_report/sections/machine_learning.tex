...
$\sim 0.1308\%$ word error rate (WER) while Test2 and Test3 is
$\sim 0\%$ WER.
...
model). The results show that Test1 took a duration of $\sim 1h 26m 13s$ for the trainig while Test2 and Test3 is $\sim 18m 50s$ and $\sim 14m 50s$ respectively.
...
\end{table}
	...
	\ref{fig:learning_test_error_fig}
