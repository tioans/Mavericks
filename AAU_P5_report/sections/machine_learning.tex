...
In Figure \ref{fig:AN} it can be seen that the neuron computes a weighted sum of all its weights and biases, which then are passed onto the activation function to be mapped, analogous to the biological function of the Soma and Axon respectively.
