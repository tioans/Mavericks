...
$0.1\%$ outperformed Test6 with a learning rate of $1\%$ by a long shot. The graph clearly shows the model didn'tx converge to zero at all, unlike Test5, meaning it didn't learn anything during training.
%----------------------------------------------------
