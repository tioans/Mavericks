...
3. The client sends an audio file \\
4. The server decodes the audio into text\\
5. The server sends the text to the client\\
...
\lstinputlisting[language=Python,caption=Server receiving file, firstline=30, lastline=35]{code/serverPy.py} 
...
\lstinputlisting[language=Python,caption=New process, firstline=39, lastline=40]{code/serverPy.py}
