...
The human brain learns from its experiences, creating new neural pathways.
These neural pathways are connected chains of neuros.
Some neural connections are stronger than others and can be modulated, or changed,
following learning or during behavioral modifications.
The strongness of the neural connections is defined by weights.
\todo{continue here}
